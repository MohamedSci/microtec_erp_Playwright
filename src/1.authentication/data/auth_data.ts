export class AuthData {
    static loginUrl = "https://intmicrotec.neat-url.com:2006/bussinessowners/";
    static registrationUrl = "https://intmicrotec.neat-url.com:2004/Register";
    static logoImg = "/assets/img/logo.webp";
    static fullName = "moah mmn";
    static emailRegex = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
    static loginMail = "neholog827@lapeds.com";
    static registerMail = "tilok94948@huleos.com";
    static sessionMail = "bupimo.urasiq@jollyfree.com";
